...
{
    internal class ProcessTableManager : ABIManaged
    {
        ...
        private readonly ProcessTableVirtualHeapManager virtualHeap;
        public ProcessTableManager(int baseAddrMap, PageAllocator pa)
        {
            BASE_ADDR = baseAddrMap;
            pageAlloc = pa;
            virtualHeap = new ProcessTableVirtualHeapManager();
        ...
        public int HeapAlloc(int size)
        {
            ...
            foreach (int page in physical_pages)
            {
                ...
                ProcessTableHeapPage entry = new ProcessTableHeapPage(emptyEntryAddr, order, page);
